...
const headerData = {
	...
	titleProp: 'Andy and Melissa Yuen',
...
const LandscapeImages = importAll(require.context('../../../images/allprojects/photo_shoots/yuen/landscape', false, /\.(jpg)$/));
...
const PortraitImages = importAll(require.context('../../../images/allprojects/photo_shoots/yuen/portrait', false, /\.(jpg)$/));
