import BackgroundImage from '../../../images/allprojects/graduation/sarah/landscape/img-4.jpg'
import { importAll, shuffleArray } from '../../helpers/functions';

const headerData = {
	bgImageProp: BackgroundImage,
	titleProp: 'Sarah Calvin',
	dateProp: 'May 2021',
	descProp: ''
};
...
const LandscapeImages = importAll(require.context('../../../images/allprojects/graduation/sarah/landscape', false, /\.(jpg)$/));
...
const PortraitImages = importAll(require.context('../../../images/allprojects/graduation/sarah/portrait', false, /\.(jpg)$/));
