import BackgroundImage from '../../../images/allprojects/travel/cambodia/landscape/img-9.jpg'
...
const LandscapeImages = importAll(require.context('../../../images/allprojects/travel/cambodia/landscape', false, /\.(jpg)$/));
...
const PortraitImages = importAll(require.context('../../../images/allprojects/travel/cambodia/portrait', false, /\.(jpg)$/));
