import BackgroundImage from '../../../images/allprojects/photo_shoots/sofia/landscape/img-1.jpg'
...
const LandscapeImages = importAll(require.context('../../../images/allprojects/photo_shoots/sofia/landscape', false, /\.(jpg)$/));
...
const PortraitImages = importAll(require.context('../../../images/allprojects/photo_shoots/sofia/portrait', false, /\.(jpg)$/));
