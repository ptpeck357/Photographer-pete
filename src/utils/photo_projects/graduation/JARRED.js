import BackgroundImage from '../../../images/allprojects/graduation/jarred/landscape/img-1.jpg'
import { importAll, shuffleArray } from '../../helpers/functions';

const headerData = {
	bgImageProp: BackgroundImage,
	titleProp: 'Jarred Acevedo',
	dateProp: 'May 2020',
	descProp: ''
};
...
const LandscapeImages = importAll(require.context('../../../images/allprojects/graduation/jarred/landscape', false, /\.(jpg)$/));
...
const PortraitImages = importAll(require.context('../../../images/allprojects/graduation/jarred/portrait', false, /\.(jpg)$/));
