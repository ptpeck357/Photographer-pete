import BackgroundImage from '../../../images/allprojects/graduation/shanna/landscape/img-1.jpg'
import { importAll, shuffleArray } from '../../helpers/functions';

const headerData = {
	bgImageProp: BackgroundImage,
	titleProp: 'Shanna Emanuelson',
...
const LandscapeImages = importAll(require.context('../../../images/allprojects/graduation/shanna/landscape', false, /\.(jpg)$/));
...
const PortraitImages = importAll(require.context('../../../images/allprojects/graduation/shanna/portrait', false, /\.(jpg)$/));
