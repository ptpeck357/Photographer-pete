import BackgroundImage from '../../../images/allprojects/engagement_wedding/jacobandraquelwedding/landscape/img-2.jpg'
import { importAll, shuffleArray } from '../../helpers/functions';

const headerData = {
	bgImageProp: BackgroundImage,
	titleProp: 'Jacob and Raquel',
	dateProp: 'December 2020',
	descProp: ''
};

const imageArray = [];

const LandscapeImages = importAll(require.context('../../../images/allprojects/engagement_wedding/jacobandraquelwedding/landscape', false, /\.(jpg)$/));
...
const PortraitImages = importAll(require.context('../../../images/allprojects/engagement_wedding/jacobandraquelwedding/portrait', false, /\.(jpg)$/));
