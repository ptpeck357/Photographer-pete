import BackgroundImage from '../../../images/allprojects/travel/banff/landscape/img-1.jpg'
import { importAll, shuffleArray } from '../../helpers/functions';

const headerData = {
	bgImageProp: BackgroundImage,
	titleProp: 'Banff National Park',
	dateProp: 'August 2017',
	descProp: ''
};

const imageArray = [];

const LandscapeImages = importAll(require.context('../../../images/allprojects/travel/banff/landscape', false, /\.(jpg)$/));
...
const PortraitImages = importAll(require.context('../../../images/allprojects/travel/banff/portrait', false, /\.(jpg)$/));
