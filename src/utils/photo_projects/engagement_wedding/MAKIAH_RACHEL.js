import BackgroundImage from '../../../images/allprojects/engagement_wedding/makiahrachel/landscape/img-2.jpg'
import { importAll, shuffleArray } from '../../helpers/functions';

const headerData = {
	bgImageProp: BackgroundImage,
	titleProp: 'Makiah and Rachel',
	dateProp: 'November 2020',
	descProp: ''
};

const imageArray = [];

const LandscapeImages = importAll(require.context('../../../images/allprojects/engagement_wedding/makiahrachel/landscape', false, /\.(jpg)$/));
...
const PortraitImages = importAll(require.context('../../../images/allprojects/engagement_wedding/makiahrachel/portrait', false, /\.(jpg)$/));
