import BackgroundImage from '../../../images/allprojects/graduation/joshua/landscape/img-1.jpg'
import { importAll, shuffleArray } from '../../helpers/functions';

const headerData = {
	bgImageProp: BackgroundImage,
	titleProp: 'Joshua Emanuelson',
	dateProp: 'May 2020',
	descProp: ''
};
...
const LandscapeImages = importAll(require.context('../../../images/allprojects/graduation/joshua/landscape', false, /\.(jpg)$/));
...
const PortraitImages = importAll(require.context('../../../images/allprojects/graduation/joshua/portrait', false, /\.(jpg)$/));
